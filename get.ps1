...
$AvailableLanguages = @(
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Get the Windows Local Language Experience Packs (LXPs) downloader online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "احصل على أداة تنزيل حزم تجربة اللغة المحلية لنظام التشغيل Windows (LXPs) عبر الإنترنت"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Изтеглете програмата за изтегляне на Windows Local Language Experience Packs (LXPs) онлайн"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Získejte online stahování balíčků Windows Local Language Experience Pack (LXPs)"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Hent Windows Local Language Experience Packs (LXP'er) Downloader online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Holen Sie sich den Windows Local Language Experience Packs (LXPs) Downloader online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Αποκτήστε το πρόγραμμα λήψης Windows Local Language Experience Packs (LXPs) Online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Descargador en línea para paquetes de experiencia de idioma local (LXP) de Windows"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtenga el descargador de paquetes de experiencia en idioma local (LXPs) de Windows en línea"
			UpdateServerSelect       = "Selección automática de servidor o selección personalizada"
			UpdateServerNoSelect     = "Por favor seleccione un servidor disponible"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Hankige Windowsi kohaliku keele kogemuspakettide (LXPs) allalaadija võrgus"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Hanki Windows Local Language Experience Packs (LXPs) Downloader Online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtenez le téléchargeur de Windows Local Language Experience Packs (LXPs) en ligne"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Téléchargeur en ligne de packs d'expérience linguistique locale (LXP) pour Windows"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "קבל את תוכנת ההורדה של Windows Local Language Experience Packs (LXPs) באינטרנט"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Preuzmite Windows Local Language Experience Packs (LXPs) Downloader Online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Szerezze be a Windows Local Language Experience Packs (LXPs) letöltőt online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Ottieni il downloader di Windows Local Language Experience Pack (LXPs) online"
	...
	@{
		...
		Language = @{
			...
			Get                      = "Windows ローカル言語エクスペリエンス パック (LXPs) ダウンローダーをオンラインで入手する"
	...
	@{
		...
		Language = @{
			...
			Get                      = "온라인으로 구매하세요 Windows 로컬 언어 경험 팩 (LXPs) 다운로더"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Gaukite Windows Local Language Experience Packs (LXPs) atsisiuntimo programą internetu"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Iegūstiet Windows vietējās valodas pieredzes pakotnes (LXPs) lejupielādētāju tiešsaistē"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Få Windows Local Language Experience Packs (LXPs) Downloader Online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Download de Windows Local Language Experience Packs ( LXPs ) Downloader online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Pobierz narzędzie do pobierania pakietów językowych lokalnego systemu Windows (LXPs) online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtenha o downloader online do Windows Local Language Experience Packs (LXPs)"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Descarregador online de Pacotes de Experiência de Língua Local (LXPs) do Windows"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obține Windows Local Language Experience Packs (LXPs) Downloader online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Получите онлайн-загрузчик пакетов расширения возможностей локального языка Windows (LXPs)"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Získajte online program na stiahnutie balíkov Windows Local Language Experience Pack (LXPs)"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Prenesite Windows Local Language Experience Packs (LXPs) Downloader Online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Набавите Виндовс пакете искуства локалног језика (LXPs) за преузимање на мрежи"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Nedladdningsprogram för Windows lokala språkupplevelsepaket (LXP) online"
	...
	@{
		...
		Language = @{
			...
			Get                      = "รับตัวดาวน์โหลด Windows Local Language Experience Packs (LXPs) ออนไลน์"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Windows Yerel Dil Deneyimi Paketleri (LXPs) İndiricisini Çevrimiçi Olarak Alın"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Отримайте онлайн-завантажувач Windows Local Language Experience Packs (LXPs)"
	...
	@{
		...
		Language = @{
			...
			Get                      = "在线获取 Windows 本地语言体验包 (LXPs) 下载器"
	...
	@{
		...
		Language = @{
			...
			Get                      = "在線獲取 Windows 本機語言體驗套件 (LXPs) 下載器"
...
Function Installation_interface_UI
{
	...
	Function Install_Init_Disk_To
	{
		switch ($UI_Main_Install_To.SelectedItem.Path) {
			"AutoSelectDisk" {}
			"Desktop" {
				Save_Dynamic -regkey "LXPs\Get" -name "InstlTo" -value "Desktop"
				return Join-Path -Path $([Environment]::GetFolderPath("Desktop")) -ChildPath $Default_directory_name
			}
			"Download" {
				Save_Dynamic -regkey "LXPs\Get" -name "InstlTo" -value "Download"
			...
			"Documents" {
				Save_Dynamic -regkey "LXPs\Get" -name "InstlTo" -value "Documents"
				return Join-Path -Path $([Environment]::GetFolderPath("MyDocuments")) -ChildPath $Default_directory_name
			}
			default {
				if (Get-ItemProperty -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Name "Instl_To_Custom" -ErrorAction SilentlyContinue) {
					$GetNewInstallTo = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Name "Instl_To_Custom" -ErrorAction SilentlyContinue
					Save_Dynamic -regkey "LXPs\Get" -name "InstlTo" -value $GetNewInstallTo
		...
		Save_Dynamic -regkey "LXPs\Get" -name "InstlTo" -value "AutoSelectDisk"
		$ExcludeDisk = @(
	...
	$IsAllowSHA256Check = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($IsAllowSHA256Check.Checked) {
				Save_Dynamic -regkey "LXPs\Get" -name "IsAllowSHA256Check" -value "True"
			} else {
				Save_Dynamic -regkey "LXPs\Get" -name "IsAllowSHA256Check" -value "False"
			}
		}
	}
		...
		add_Click      = {
			...
			if ($FolderBrowser.ShowDialog() -eq "OK") {
				if (Test_Available_Disk -Path $FolderBrowser.SelectedPath) {
					...
					Save_Dynamic -regkey "LXPs\Get" -name "Instl_To_Custom" -value $UI_Main_Save_To_Path.Text
					Save_Dynamic -regkey "LXPs\Get" -name "InstlTo" -value $UI_Main_Save_To_Path.Text
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Name "InstlTo" -ErrorAction SilentlyContinue) {
		$GetNewInstallTo = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Name "InstlTo" -ErrorAction SilentlyContinue
	...
	#>
		...
		if ($DvHash) {
			...
			if (Get-ItemProperty -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Name "IsAllowSHA256Check" -ErrorAction SilentlyContinue) {
				$GetIsAllowSHA256Check = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Name "IsAllowSHA256Check" -ErrorAction SilentlyContinue
			...
			if ([string]::IsNullOrEmpty($UI_Main_To.SelectedItem.Path)) {
				...
				switch ($UI_Main_To.SelectedItem.Path) {
					"Main" {
						...
						$test_new_File = Join-Path -Path $UI_Main_Save_To_Path.Text -ChildPath "LXPs.ps1"
...
#>
if ($Reset) {
	Remove-Item -Path "HKCU:\SOFTWARE\Yi\LXPs\Get" -Force -Recurse -ErrorAction SilentlyContinue | Out-Null
}
