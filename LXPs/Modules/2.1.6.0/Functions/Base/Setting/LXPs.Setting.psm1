...
Function Setting_UI
{
	...
	$UI_Setting_Auto_Update = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "LXPs\Update" -name "IsAutoUpdate" -value "False"
	...
	$UI_Setting_Auto_Update_Clean = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($This.Checked) {
				Save_Dynamic -regkey "LXPs\Update" -name "IsUpdate_Clean_Allow" -value "True"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
				$UI_Main_Error.Text = "$($lang.UpdateClean), $($lang.Enable), $($lang.Done)"
			} else {
				Save_Dynamic -regkey "LXPs\Update" -name "IsUpdate_Clean_Allow" -value "False"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
	...
	$UI_Setting_Auto_Update_New_Allow = New-Object System.Windows.Forms.CheckBox -Property @{
		...
		add_Click      = {
			...
			if ($This.Checked) {
				...
				Save_Dynamic -regkey "LXPs\Update" -name "IsAutoUpdateNew" -value "False"
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
	...
	$UI_Setting_Auto_Update_Adv_Auto_Check_Setting = New-Object system.Windows.Forms.NumericUpDown -Property @{
		...
		add_ValueChanged = {
			...
			Save_Dynamic -regkey "LXPs\Update" -name "AutoCheckUpdate_Hours" -value $This.Value
			$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\..\..\..\..\Assets\icon\Success.ico")
	...
	if (Get-ItemProperty -Path "HKCU:\SOFTWARE\$($Global:Author)\LXPs\Update" -Name "AutoCheckUpdate_Hours" -ErrorAction SilentlyContinue) {
		$UI_Setting_Auto_Update_Adv_Auto_Check_Setting.Value = Get-ItemPropertyValue -Path "HKCU:\SOFTWARE\$($Global:Author)\LXPs\Update" -Name "AutoCheckUpdate_Hours" -ErrorAction SilentlyContinue
	} else {
