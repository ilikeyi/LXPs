...
Function Language_Select_GUI
{
	...
	$IconYi = "$($PSScriptRoot)\$((Get-Module -Name LXPs).Version.ToString())\Assets\icon\Yi.ico"
	...
	$UI_Main_OK        = New-Object system.Windows.Forms.Button -Property @{
		...
		add_Click      = {
			...
			if ($FlagsLanguageCheck) {
				...
				$UI_Main_Error_Icon.Image = [System.Drawing.Image]::Fromfile("$($PSScriptRoot)\$((Get-Module -Name LXPs).Version)\Assets\icon\Error.ico")
